    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "Ativo", "IconCSS", "Nome" },
                values: new object[] { 1, true, "fas fa-spa", "Beleza" });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "Ativo", "NomeUsuario" },
                values: new object[] { 1, true, "Admim Teste" });

            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "Id", "Ativo", "CategoriaId", "Descricao", "ImgUrl", "Nome", "Preco", "Quantidade" },
                values: new object[] { 1, true, 1, "Kit fornecido pela Natura", "", "Glossier - Beleza Kit", 100m, 100 });
